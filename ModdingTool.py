...
class App(tk.Tk):
    ...
    def show_state_manager_ui(self):
        ...
        # 2. Homelands
        h_frame = ttk.LabelFrame(f, text="Homelands", padding=10)
        h_frame.pack(fill=tk.X, pady=5)

        self.lb_homelands = tk.Listbox(h_frame, height=4, bg="#424242", fg="#ECEFF1")
        ...
        self.cb_homeland_add = ttk.Combobox(h_ctrl, textvariable=self.sm_homeland_add, width=20)
        ...
        ttk.Button(h_ctrl, text="Remove Selected", command=self.remove_state_homeland).pack(fill=tk.X, pady=2)
        ttk.Button(h_ctrl, text="Save Homelands", command=self.save_state_homelands_ui).pack(fill=tk.X, pady=(10, 2))
